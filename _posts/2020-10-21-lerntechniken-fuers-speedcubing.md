...
## Muscle Memory im Vergleich zu anderen Lernstrategien

#### Was ist Mucle Memory

Das Thema Muscle Memory begegnet dir sicherlich öfter, wenn du dich mit anderen über gelernte Algorithmen unterhältst. Denn tatsächlich nutzen Cuber genau diese Form des Gedächtnisses, um Algorithmen und ihre Fingertricks zu behalten.

{:.box-note}
**Notiz:** Muscle Memory steht für das Muskelgedächtnis, mit dem motorische Abläufe im Gehirn kodiert werden. In verschiedenen Phasen des Lernens von z.B. Fingertricks für bestimmte Moves oder ganzen Algorithmen sind verschiedene Bereiche des Gehirns aktiv. Das aktive Üben kann sich daher für dich ganz anders anfühlen als die spätere, als automatisch wahrgenommene Ausführung. Beim Lernen solltest du daher aufmerksam sein, um die Synapsen, ich sage mal umgangssprachlich "korrekt zu verschalten". Später wird das Abrufen der gelernten Information dann nicht mehr so schwierig sein, Voraussetzung ist aber, dass der Ablauf gut geübt wird. Das Thema ist wahnsinnig interessant, wusstest du zum Beispiel, dass neuronale Prozesse auch dann noch aktiv sind, wenn du dein eigentliches Training schon beendet hast? Daraus schließe ich, dass Pausen wichtig sind, um genau diese Phase auszunutzen. Als Analogie zu dir bekannten Aktivitäten kann man wieder Dinge wie Fahrrad oder Auto fahren nennen, aber auch das Bedienen der Tastatur.

#### Was bringt mir Muscle Memory?

Wie kann dir dieses Wissen nun behilflich sein? Die kurze Antwort lautet: alle Notation ist ja ganz nett, aber versuche die Ausführung schon früh ohne das Ablesen von Moves und eher über die Bewegungen zu lernen. Klar lässt sich das noch damit kombinieren, wie sich einzelne Trigger (siehe oben) "anfühlen", und dann lassen sie sich aneinanderreihen. Damit du aber auch wirklich das Muskelgedächtnis verwendest, und nicht doch an z.B. "jetzt kommt gleich R U" denkst, schaue beim Lernen der Algorithmen früh von deiner Vorlage weg, konzentriere dich darauf, was deine Hände tun, wo sie sich befinden, oder welche Finger beteiligt sind. Auch darauf wirst du nach einigen Durchgängen der Wiederholung verzichten können.

{:.box-warning}
**Beachte:** Die Technik eignet sich wahnsinnig gut, um neu gelernte Algorithmen schnell brauchbar zu machen. Was dabei aber eventuell verloren geht, ist das Verständnis für den Algorithmus. Wenn du nur auf Muscle Memory setzt, und kein "Backup" lernst, kann es zu Problemen kommen. Du könntest den Algorithmus ganz einfach vergessen, und wüsstest (ohne die ersten Drehungen zu kennen) nicht, wie der Algorithmus funktioniert. Bei manchen Algorithmen würdest du vielleicht nicht im Ansatz darauf kommen. Weiterhin kann es dir ohne das Verständnis bzw. ohne eine andere Form der Informationsspeicherung passieren, dass du den Algorithmus nicht langsamer als in deiner gewohnten Geschwindigkeit ausführen kannst. Dies wird dir zum Verhängnis, wenn du beispielsweise von 3x3 auf Bigcubes gehst. Außerdem musst du dich beim Onehandedlösen komplett neu orientieren, weißt dann eventuell die Moves nicht auswendig, und kannst sie daher auch nicht auf eine Hand übertragen, weil der motorische Ablauf anders ist, trotz identischem Algorithmus. Und der ein oder andere Algorithmus fühlt sich mit Blindfold auf einmal auch ganz anders an.

#### Eine gute Balance zwischen den verschiedenen Lernstrategien

Wie kannst du nun von Muscle Memory profitieren, ohne dir dabei gleich neue, andere Probleme zu schaffen? Die Lösung ist, auf verschiedene Techniken zu vertrauen, die alle für sich in verschiedenen Situationen nützlich sind. Fürs Speedsolven und um einfach das Algorithmenset zu pauken, welches dir bessere Zeiten bringt, bei egal welcher Erfahrungsstufe, ist Muscle Memory sehr wichtig und hilfreich. Sobald du aber vor hast, etwas mehr in die Tiefe zu gehen, oder auch wenn andere Events hinzukommen, wenn du verstehen wilsst, was da eigentlich passiert, wenn du öfter mal Phasen hast, in denen du nicht zum Üben kommst, dann nutze auch die "härtere" Variante. Darunter fällt sich auch ein paar Moves als Sequenz von Buchstaben zu merken, sozusagen als "Fallback-Option", falls die Information aus dem Muskelgedächtnis verschwunden ist, oder mal durch falsche Bewegungen und Gedankengänge überschrieben wurde. Sollte ich je die Ausführung des T-Perms vergessen (die Hände also nicht sofort mit dem Drehen loslegen und den Algorithmus korrekt beenden), dann wüsste ich zumindest die ersten 6 Schritte auch in Buchstabennotation auswendig. Aber auch nur, weil ich weiß, dass der Anfang ein Trigger ist, der Rest ergibt sich dann.

#### Back-Ups für deine Algorithmen

Was muss man für Back-Ups von Algorithmen wissen oder tun? Einerseits wie oben eräwhnt entweder stur einzelne Moves lernen, oder Trigger lernen. Außerdem lohnt es sich, zum Beispiel bei den Algorithmen der Last Layer, mal bestimmte F2L-Pairs während des Algs zu verfolgen. Im Zweifelsfall (wenn du bei der Ausführung des Algorithmus nicht mehr weiter weißt), dann erinnerst du dich vielleicht nicht an die Bewegungen, oder die Moves in Singmaster-Notation, aber du erinnerst dich alternativ an "das Pair muss jetzt noch in den Backslot rechts eingesetzt werden". Je mehr Back-Up-Strategien du nutzt, umso wahrscheinlicher ist es, dass du einmal gelernte Algorithmen nie wieder nachsehen musst.

Zusammengefasst solltest du folgende Techniken nutzen:
* Muscle Memory für den Bewegungsablauf [**prozedural, motorisch**],
* pures Auswendiglernen wichtiger Anknüpfungspunkte im Algorithmus in Form der Notation [**semantisch, sprachlich**],
* Visualisierung / Beschreibung des Verhaltens einzelner Teile (lässt sich z.B. durch Tracken von einzelnen Pieces / F2L-Pairs / Blöcken erreichen) [**räumlich, visuell**]
